  ...
  return (
    <div className="help" style={{ maxWidth: 860, lineHeight: 1.65 }}>
      ...
      <ul>
        ...
        <li><b>My DB (works right here too)</b> is the power tool for a whole folder of demos (scrims, officials, POV) — it lives at <code>/mydb</code> (linked from Analyze). Pick your folder once (Chrome/Edge); unprocessed demos are parsed one by one — stop anytime, it resumes. You get a local <b>team report</b> and strategy clustering over your own matches.</li>
        <li><b>Privacy by design:</b> on this site your demos are parsed <i>entirely in your browser</i> and never travel anywhere; on a self-hosted studio they visit your own server only for parsing. Results live in a <code>.freezetime/</code> folder next to your demos — portable, re-importable on any machine in seconds.</li>
